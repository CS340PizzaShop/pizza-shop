...
<?php
    ...
    else
    {
        ...
        header('Refresh: .1; URL=http://localhost/pizza-shop/HTML/generate_report.html'); //  redirects to the same login page to try again after .1 second(so it can show the failure message)
        die();
    }
